...
describe("utils", () => {
  ...
  describe("#shortenAddress", () => {
    ...
    `(
      "$desc for shortenAddress($input) should return $expected",
    ...
    it("allows custom amounts of start/end chars", () => {
      ...
      expect(
        shortenAddress("0x2E1b342132A67Ea578e4E3B814bae2107dc254CC", 0, 4)
      ).toBe("0x...54CC");
      expect(
        shortenAddress("0x2E1b342132A67Ea578e4E3B814bae2107dc254CC", 0)
      ).toBe("0x...");
      expect(
        shortenAddress("0x2E1b342132A67Ea578e4E3B814bae2107dc254CC", 44)
      ).toBe("0x2E1b342132A67Ea578e4E3B814bae2107dc254CC");
      expect(
        shortenAddress("2E1b342132A67Ea578e4E3B814bae2107dc254CC", 43)
      ).toBe("0x2E1b342132A67Ea578e4E3B814bae2107dc254CC");
      expect(
        shortenAddress("2E1b342132A67Ea578e4E3B814bae2107dc254CC", 1, 55)
      ).toBe("0x2E1b342132A67Ea578e4E3B814bae2107dc254CC");
    });
  });
});
